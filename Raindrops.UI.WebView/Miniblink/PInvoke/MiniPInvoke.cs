...
namespace Raindrops.UI.WebView.Miniblink.PInvoke
{
    ...
    [UnmanagedFunctionPointer(NativeConstants.MB_CALL_TYPE)]
    unsafe public delegate mbDownloadOpt mbDownloadInBlinkThreadCallback(mbWebView webview, IntPtr param, UIntPtr expectedContentLength,  [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8Marshaler))] string url,  [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8Marshaler))] string mime,  [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8Marshaler))] string disposition, mbNetJob job, IntPtr dataBind);
    [StructLayout(LayoutKind.Sequential)]
